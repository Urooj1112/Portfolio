        ...
        <div className="flex justify-between items-center h-screen p-5">
            ...
            <div className=" relative w-full md:w-1/2 flex justify-center items-center">
                ...
                <div className="absolute  ml-[-120px] mt-[-40px] top-[50%] left-[50%] flex justify-center flex-col items-center ">
                    ...
                    <h3 className="font-bold  ml-[50px] mr-[50px] text-[30px] mb-[20px] mt-[-90px]">I'm Urooj Saeed, <span className="text-[#A59D84] "> FrontEnd Developer</span></h3>
            ...
            <div className="w-full md:w-1/2 flex justify-center items-center">
                <Image
                    src="/images/pic1.png"  // Replace with your image path
                    alt="Example Image"
                    width={400}
                    height={400}
                    className="object-cover rounded-md shadow-md mb-[20px] mr-[100px]"
                />
            </div>
        </div>
    );
